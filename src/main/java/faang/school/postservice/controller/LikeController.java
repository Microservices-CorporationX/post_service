...
public class LikeController {
    ...
    public LikeCommentDto removeLikeFromComment(@PathVariable Long likeId) {
        return likeService.removeLikeComment(likeId);
    }

    @DeleteMapping(USER_PATH_POST + REMOVE)
    public LikePostDto removeLikeFromPost(@PathVariable Long likeId) {
        return likeService.removeLikePost(likeId);
    }
}
