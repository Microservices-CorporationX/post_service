...
import ru.corporationx.postservice.config.web.FormFeignEncoderConfig;
import ru.corporationx.postservice.dto.grammar.SpellResultDto;
...
@FeignClient(name = "speller-client", url = "${post-correction.api-url}",
